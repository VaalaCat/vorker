...
type Worker struct {
	...
	Code            []byte `protobuf:"bytes,7,opt,name=Code,proto3" json:"Code,omitempty"`                        // worker's code, will be ignored if ActiveVersionID is not null
	...
	Template        string `protobuf:"bytes,11,opt,name=Template,proto3" json:"Template,omitempty"`               // worker's template
	ActiveVersionID string `protobuf:"bytes,12,opt,name=ActiveVersionID,proto3" json:"ActiveVersionID,omitempty"` // worker's version id, if this field is not null, the worker's code will be ignored
}
...
func (x *Worker) GetTemplate() string {
	if x != nil {
		return x.Template
	}
	return ""
...
func (x *Worker) GetActiveVersionID() string {
	if x != nil {
...
type Node struct {
	...
	UID  string `protobuf:"bytes,2,opt,name=UID,proto3" json:"UID,omitempty"`   // the id of the node
}

func (x *Node) Reset() {
	*x = Node{}
	if protoimpl.UnsafeEnabled {
		mi := &file_wokerd_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Node) Descriptor() ([]byte, []int) {
	return file_wokerd_proto_rawDescGZIP(), []int{2}
}
...
var file_wokerd_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x66, 0x73, 0x22, 0xc2, 0x02, 0x0a, 0x06, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x12,
	...
	,
...
func file_wokerd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_wokerd_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Node); i {
			case 0:
				return &v.state
			case 1:
